# Последовательность. Хранит последовательность целых чисел. Методы: 
# 	вывод в консоль; 
# 	определение типа (убывающая; возрастающая; неубывающая; невозрастающая; геометрическая, арифметическая прогрессия); 
# 	конструктор ручного ввода; 
# 	конструктор случайной генерации (может принимать на вход также параметр, гарантирующий убывание; возрастание; неубывание; невозрастание); 
# 	запись в файл; 
# 	конструктор чтения из файла; 
# 	проверка принадлежности введенного пользователем элемента; 
# 	сравнение двух последовательностей; 
# 	поиск максимума и минимума; 
# 	определение разделителей подпоследовательностей (положительные; отрицательные; нули; локальные экстремумы подпоследовательностей); 
# 	поиск наибольшей и наименьшей подпоследовательностей (по длине); 
# 	экстраполяция прогрессии на введенное пользователем число элементов N; 
# 	деструктор с сообщением об удалении
